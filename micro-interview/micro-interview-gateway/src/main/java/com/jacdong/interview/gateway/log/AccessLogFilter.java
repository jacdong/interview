...
public class AccessLogFilter implements GlobalFilter, Ordered {
    ...
    private Mono writeBodyLog(ServerWebExchange exchange, GatewayFilterChain chain, GatewayLog gatewayLog) {
        ...
        GatewayCachedBodyOutputMessage outputMessage = new GatewayCachedBodyOutputMessage(exchange, headers);
    ...
    private ServerHttpRequestDecorator requestDecorate(ServerWebExchange exchange, HttpHeaders headers,
    		GatewayCachedBodyOutputMessage outputMessage) {
